        ...
        <!-- <a class="w3-button w3-blue" href="students.php">View</a> -->
            <div class="w3-card-4">
                <div class="w3-container w3-blue">
                    <h4>Field training application</h4>
                </div>
                <p><a style="color:red;" href="check_application_student.php">Already applied?</a></p>
                    ...
                    <label>Attachment:</label><input style="width:100%;" class="" type="file" name="file" placeholder="" required>
                    ...
                    <label>Applied on:<label><input style="width:100%;" class="" type="date" name="student_reg_date" placeholder="" required><br><br>
